...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.log('[Login] Attempting Google login with redirectTo:', redirectTo)
      ...
      if (oauthError) {
        ...
        alert('Google Login Error: ' + oauthError.message)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: "#F8FAFC" }}>
      <div className="w-full max-w-md">
        ...
        >
          <h2 className="text-xl font-semibold mb-2 text-center" style={{ color: "#0F172A" }}>Welcome back</h2>
          <p className="text-sm text-center mb-8" style={{ color: "#64748B" }}>Enter your credentials to access your dashboard</p>
          ...
          <div className="mt-8 pt-6 text-center" style={{ borderTop: "0.67px solid #F1F5F9" }}>
            <p className="text-sm" style={{ color: "#64748B" }}>
              ...
              <Link href="/signup" className="font-medium" style={{ color: "#10B981" }}>
                Create an account
              </Link>
            </p>
          </div>
